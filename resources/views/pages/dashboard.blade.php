...
<div class="bg-container bg-gray-30 h-full">
    <div class="mx-auto container py-3 my-6 font-body md:px-0 px-3">
        ...
        <div
            ...
            <a href="{{route('account.date-clienti')}}" class="hover:shadow-md rounded-md">
            ...
            <a href="{{route('factura.all')}}" class="hover:shadow-md rounded-md">
            ...
            <a href="" class="hover:shadow-md rounded-md">
