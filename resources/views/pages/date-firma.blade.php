...
<div class="bg-container h-full">
    <div class="mx-auto container py-3 my-6 font-body md:px-0 px-3">
        ...
        @if($user->dateFirma)
        <div class="mx-auto container border-gray-300 border rounded-t-md py-3 my-8 px-3 font-body text-sm">
            ...
            <div class="actions flex">
                <form action="{{route('date-firma.destroy', $user->dateFirma->id)}}" method="POST"
        ...
        @else
        <form action="{{route('date-firma.getdetails', ['id' => $user->id])}}" method="POST"
