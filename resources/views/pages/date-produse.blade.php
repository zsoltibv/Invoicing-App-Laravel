        ...
        <form action="{{route('date-produse.store', ['id' => $user->id])}}" method="POST" enctype="multipart/form-data" class="mt-6">
            ...
            <div
                ...
                <div class="controls">
                    ...
                    <div class="py-3 flex flex-col">
                        <input id="pret" type="number" step="any" class="rounded-md bg-gray-50 border border-gray-300 text-gray-900 text-sm focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500
