        ...
        <div class="info text-md py-6">
            <div class="section py-3">
                ...
                <div class="flex pl-4 text-sm font-medium">
                    ...
                    <p> Neincasata<br><span class="text-red-600">(Rest de incasat {{
                            $invoice->formatCurrency($invoice->total_amount) }})</span></p>
                </div>
            </div>
            <div class="section py-3">
        ...
        <div class="factura h-full py-6">
            <div class="controls mb-3 flex justify-between">
                ...
                <div class="align-end flex gap-3">
                    ...
                    <a href="{{route('factura.download', Crypt::encrypt($invoice->url()))}}" onclick="event.preventDefault();
                        ...
                        <button
                            ...
                            <form id="download"
                                action="{{ route('factura.download',  Crypt::encrypt($invoice->url())) }}" method="POST"
                                class="d-none">
                                @csrf
                            </form>
                        </button>
            ...
            <iframe src="{{route('factura.preview', $user->id, $preview)}}"
